...
const { FIELDS: TRADING_TICKER_FIELDS } = require('bfx-api-node-models/lib/trading_ticker')
const { FIELDS: FUNDING_TICKER_FIELDS } = require('bfx-api-node-models/lib/funding_ticker')
