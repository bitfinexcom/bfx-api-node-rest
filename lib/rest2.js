...
class RESTv2 {
  ...
  payPublicInvoiceUpdate (params, cb = null) {
    return this._makeAuthRequest('/auth/ext/pay/invoice/update', params, cb)
  }
  ...
  payInvoiceRegenerate (params, cb = null) {
    return this._makeAuthRequest('/ext/pay/invoice/regenerate', params, cb)
  }
  ...
  payInvoiceFeedback (params, cb = null) {
    return this._makeAuthRequest('/ext/pay/invoice/feedback', params, cb)
  }
  ...
  payPublicInvoiceCurrencyDetailed (params, cb = null) {
    return this._makeAuthRequest('/ext/pay/invoice/currency/detailed', params, cb)
  }  
  ...
  payInvoiceCurrencyDetailed (params, cb = null) {
    return this._makeAuthRequest('/auth/r/ext/pay/currency/detailed', params, cb)
  }  
   ...
   * @returns {Promise} p
   */
   payInvoiceCurrencyList (params, cb = null) {
