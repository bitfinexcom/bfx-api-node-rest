...
class RESTv2 {
   ...
   *
   * @param {object} params       - parameters
   * @param {number[]} params.id  - list of Order ID's
   * @param {number[]} params.gid - list of Group ID's
   * @param {number} params.all   - Cancel all open orders if value is set to: 1
   * @param {Function} [cb]       - callback
   * @returns {Promise} p
