 ...
 * @private
 *
 * @param {bfx-api-node-models.Notification~Data} data - data
 * @returns {bfx-api-node-models.Notification} n
 */
...
class RESTv2 {
   ...
   * @param {string} [opts.affCode=null] - affiliate code to be applied to all
   *   orders
   * @param {string} [opts.apiKey=''] - API key
   * @param {string} [opts.apiSecret=''] - API secret
   * @param {string} [opts.authToken=''] - auth option
   * @param {string} [opts.company=''] - currency query suffix
   * @param {string} [opts.url='https://api.bitfinex.com'] - endpoint URL
   * @param {boolean} [opts.transform=false] - enables automatic conversion of
   *   received data to model instances
   * @param {object} [opts.agent=null] - node agent for connection (proxy)
   */
  constructor (opts = {
    affCode: null,
    apiKey: '',
   ...
   * @returns {Array[]} list - merged arr of currencies and names sorted with
   * no pairs repeated adding pool and explorer to each
   */
   ...
   * @param {string} [prec='P0'] - precision
   * @param {Function} [cb] - callback
   * @returns {Promise} p
  ...
  /**
   * @param {string} [type='deriv'] - type
   * @param {string[]} [keys=['ALL']] - keys
   * @param {Function} [cb] - callback
   * @returns {Promise} p
   ...
   * @param {number} [limit=250] - query limit
   * @param {Function} [cb] - callback
   * @returns {Promise} p
   ...
   * @param {string} [context='hist'] - context
   * @param {Function} [cb] - callback
   * @returns {Promise} p
   ...
   *
   * @param {object} opts - options
   * @param {string} [opts.timeframe] - 1m, 5m, 15m, 30m, 1h, 3h, 6h, 12h, 1D,
   *   7D, 14D, 1M
   ...
   * @param {number} [start] - query start
   * @param {number} [end] - query end
   * @param {number} [limit=25] - query limit
   * @param {Function} [cb] - callback
   * @returns {Promise} p
   ...
   * @param {number} [start] - query start
   * @param {number} [end] - query end
   * @param {number} [limit=50] - query limit
   * @param {Function} [cb] - callback
   * @returns {Promise} p
   ...
   * Submit new order
   *
   * @param {bfx-api-node-models.Order} order - order model instance
   * @param {Function} [cb] - callback
   * @returns {Promise} p
   */
