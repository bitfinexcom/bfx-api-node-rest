...
class RESTv2 {
  ...
  /**
   * Returns a object with the 30-day summary of your trading volume, return on margin
   * funding, trading fees, the leo level, amount of leo hold and more details on fees.
   *
   * @param {Function} [cb] - callback
   * @returns {Promise} p
   * @see https://docs.bitfinex.com/reference#rest-auth-summary
   */
  accountSummaryFull (cb) {
