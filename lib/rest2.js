...
class RESTv2 {
   ...
   *                                                    is 5 mins and maximal duration is 24 hours. Default value is
   *                                                    15 minutes
   * @param {string} params.orderId                   - reference order identifier in merchant's platform
   * @param {string} params.webhook                   - the endpoint that will be called once the payment is completed
   *                                                    or expired
   * @param {string} params.redirectUrl               - merchant redirect URL, this one is used in UI to redirect
   *                                                    customer to merchant's site once the payment is completed or
   *                                                    expired
   ...
   *                                                    (alpha2 preffered)
   * @param {string} params.customerInfo.residCountry - customer's residential country, alpha2 code or full country
   *                                                    name (alpha2 preffered)
