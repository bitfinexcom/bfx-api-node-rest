...
class RESTv2 {
   ...
   * @param {string} [opts.urlV1] - endpoint URL for RESTv1 calls, default value same as opts.url
  ...
  constructor (opts = {
    ...
    const optsV1 = _pick(opts, ['affCode', 'apiKey', 'apiSecret', 'authToken', 'transform', 'agent'])
    optsV1.url = opts.urlV1 || opts.url
    this._rest1 = new RESTv1(optsV1)
  }
